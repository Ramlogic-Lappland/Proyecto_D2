...
namespace Gaskellgames.EditorOnly
{
    ...
    public class GaskellgamesHubSettings_SO : GgScriptableObject
    {
        ...
        #region Hierarchy Breadcrumbs [TODO]
        
        internal enum HierarchyBreadcrumbOptions
        {
            Always,
            Never
        }
        ...
        internal HierarchyBreadcrumbOptions showHierarchyBreadcrumbs = HierarchyBreadcrumbOptions.Never;
