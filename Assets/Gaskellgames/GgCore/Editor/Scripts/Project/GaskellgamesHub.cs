...
namespace Gaskellgames.EditorOnly
{
    ...
    public class GaskellgamesHub : GgEditorWindow
    {
        ...
        // settings - helper
        private float settingsLabelWidth => windowWidth * 0.25f;
        private float settingsWidth => windowWidth * 0.5f;
        ...
        protected override void OnPageGUI()
        {
            ...
            HandleShowHierarchyBreadcrumbs();
        ...
        private void HandleShowAtStartUp()
        {
            ...
            GaskellgamesHubSettings_SO.HubAutoLaunchOptions selected = (GaskellgamesHubSettings_SO.HubAutoLaunchOptions)EditorGUILayout.EnumPopup(label, EditorWindowUtility.settings.showHubOnStartup, GUILayout.Width(settingsWidth));
        ...
        private void HandleShowPackageBanners()
        {
            ...
            GaskellgamesHubSettings_SO.PackageBannerOptions selected = (GaskellgamesHubSettings_SO.PackageBannerOptions)EditorGUILayout.EnumPopup(label, EditorWindowUtility.settings.showPackageBanners, GUILayout.Width(settingsWidth));
            EditorGUIUtility.labelWidth = defaultWidth;
        ...
        private void HandleShowHierarchyBreadcrumbs()
        {
            // float defaultWidth = EditorGUIUtility.labelWidth;
            // EditorGUIUtility.labelWidth = settingsLabelWidth;
            // GUIContent label = new GUIContent("Show Hierarchy Breadcrumbs", "Show or hide the hierarchy Breadcrumbs.");
            // GaskellgamesHubSettings_SO.HierarchyBreadcrumbOptions selected = (GaskellgamesHubSettings_SO.HierarchyBreadcrumbOptions)EditorGUILayout.EnumPopup(label, EditorWindowUtility.settings.showHierarchyBreadcrumbs, GUILayout.Width(settingsWidth));
            // EditorGUIUtility.labelWidth = defaultWidth;
            // if (EditorWindowUtility.settings.showHierarchyBreadcrumbs == selected) { return; }
            // EditorWindowUtility.settings.showHierarchyBreadcrumbs = selected;
            // EditorUtility.SetDirty(EditorWindowUtility.settings);
        }
        ...
        private void HandleShowHierarchyIcons()
        {
            ...
            GaskellgamesHubSettings_SO.HierarchyIconOptions selected = (GaskellgamesHubSettings_SO.HierarchyIconOptions)EditorGUILayout.EnumPopup(label, EditorWindowUtility.settings.showHierarchyIcons, GUILayout.Width(settingsWidth));
            EditorGUIUtility.labelWidth = defaultWidth;
        ...
        private void HandleTransformExtension()
        {
            ...
            GaskellgamesHubSettings_SO.TransformInspectorOptions selected = (GaskellgamesHubSettings_SO.TransformInspectorOptions)EditorGUILayout.EnumPopup(label, EditorWindowUtility.settings.transformInspectorOptions, GUILayout.Width(settingsWidth));
            EditorGUIUtility.labelWidth = defaultWidth;
